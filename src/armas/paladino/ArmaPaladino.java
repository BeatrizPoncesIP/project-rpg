/**
 * Classe abstrata que representa uma arma específica para paladinos em um jogo de RPG.
...
public abstract class ArmaPaladino extends Arma{
   ...
   /**
    * Construtor protegido da classe ArmaPaladino.
    * 
    * @param nome O nome da arma.
    * @param modDano O modificador de dano da arma.
    */
   protected ArmaPaladino(String nome, double modDano) {
      super(nome, modDano);
   }
}
